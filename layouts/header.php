...
<!-- MENU FOR MOBILE DEVICE -->
			...
			<div class="wrap-header-mobile">
				...
				<a href="../../"><img src="images/icons/HMLPRTCUSTOM.png" alt="LOGO"></a>
				</div>
...
?>
					...
					<?php }?>
					<li style="background-color:#222222!important;">
					<a href="English" target="_blank" ><span style="color:white!important;font-weight:bold">ENGLISH</span></a></strong>
					</li>
					<li style="background-color:#222222!important;">
...
<!-- MENU FOR MOBILE DEVICE END -->
			...
			<div class="wrap-logo" style="margin-left:50px">
				<!-- Logo desktop -->		
				<div class="logo">
				<a href="../../"><img style="width:100%;height:100%" src="images/icons/HMLPRTCUSTOM.png"  alt="LOGO"></a>
				</div>	
				...
				<?php
					...
					<!-- Menu desktop -->
						...
						<a class="logo-stick" href="index.html">
							<img src="images/icons/HMLPRTCUSTOM.png" alt="LOGOIMAGE">
						</a>
						...
						<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#222222!important;height: 45px;">
  								...
  								<a class="navbar-brand" href="/"><i style="padding-left:20px;color:white"; class="fas fa-home"></i></a>
...
?>
						...
						<strong><a href="English" target="_blank" class="moen ml-3"><span style="color:white!important;font-weight:bold">ENGLISH</span></a></strong>
