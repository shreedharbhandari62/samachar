...
<html>
	...
	<div  style="width:95%">
		<?php
					...
					<center><a href="<?php echo $key['advertisement_url']; ?>" target="_blank"><img loading="lazy" width="95%"  src="backend/advertisementImage/<?php echo $key['advertisement_image']; ?>"   alt="" ></a></center>
				<?php } 
...
<br><br>
	...
	<!-- Feature post -->
	<center><div style="background-color:#027ab5;color: white;border-radius: 15px;width:200px;height:50px;font-size:20px;text-align:center;padding-top:11px"><strong>ताजा समाचार</strong></div><br></center>
	<?php
								...
								?>
									...
									<div class="col-sm-6">
												  <div class="card" style="margin:3px;border-radius:20px">
													...
													<video loading="lazy" width="100%" height="100%" poster="../backend/videoImage/<?php echo $value['news_featuredimage'] ?>" controls>
