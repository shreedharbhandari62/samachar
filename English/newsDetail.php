...
<html>
    <head>
        <title><?php echo $result['news_title']; ?></title>
    </head>
</html>
...
<div class="addthis_inline_share_toolbox"></div>
						...
						<?php
							...
							$otherWritings=GetWritingsByAuthorEnglish($conn,$result['news_writtenby'],$result['news_id']);
						?>	
...
<div class="fb-comments" data-href="<?php echo $actual_link; ?>" data-numposts="5" data-width="100%"></div>
