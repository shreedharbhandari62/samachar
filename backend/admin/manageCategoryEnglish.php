                ...
                <?php if (isset($_SESSION['msg']))  echo $_SESSION['msg']; unset($_SESSION['msg']);?>
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody>
                            <?php $catagories=getAllCategoriesEnglish($conn);
                                ...
                                <td class="center hidden-phone"><?php if($catagory['is_active']=='active'): ?>
															...
															<?php else: ?>
																<span class="label label-sm label-danger">
																	Inactive</span>
															<?php endif; ?></td>
                                <td class="hidden-phone"><a href="editCategoryEnglish.php?ref=<?php echo $catagory['category_id'];?>" class="btn btn-xs btn-info">
																	Edit
																</a>
																<a href="deleteCategoryEnglish.php?ref=<?php echo $catagory['category_id'];?>" onclick="return confirm('Really Deleting that user??');" class="btn btn-xs btn-danger">
																	Delete
																</a></td>
                            </tr>
                            <?php endforeach; ?>
