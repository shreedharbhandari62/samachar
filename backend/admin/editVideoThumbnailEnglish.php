                    ...
                    <div class="widget yellow">
                        ...
                        <div class="widget-body form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="file" class="span6" required name="news_featuredimage" accept="image/png, image/jpeg, image/gif" />                              
                                </div>
                            </div>  
...
if(isset($_POST['updateThumbnail'])){
    $name = $_FILES['news_featuredimage']['name'];
    $type = explode('.',$name);
    $type = end($type);
    $size= $_FILES['news_featuredimage']['size'];
...
if(updateVideoThumbnailEnglish($conn, $_POST,$ref,$videoName)){
