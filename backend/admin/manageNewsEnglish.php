                ...
                <?php if (isset($_SESSION['msg']))  echo $_SESSION['msg']; unset($_SESSION['msg']);?>
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody>
                            <?php $allNews=getAllNewsDetailsEnglish($conn);
                           // dump($allNews);
                            ...
                            <tr class="odd gradeX">
                              ...
                              <?php endif; ?></td>
                                ...
                                <td><?php 
                                  $newsImage=$news['news_image'];
                                   ?>
                                     <img src="../newsImage/<?php echo $newsImage; ?>" alt="News Image" width="200px"/><hr/>
                              ...
                              <?php else: ?>
                                <span class="label label-sm label-danger">
                                  No</span>
                              <?php endif; ?></td>
                                <td class="hidden-phone"><a href="editNewsEnglish.php?ref=<?php echo $news['news_id'];?>" class="btn btn-xs btn-info">
                                  Edit News
                                </a>
                                <?php if($news['category_id']=='4'){?>
                                  <hr>
                                <a href="editWriterImageEnglish.php?ref=<?php echo $news['news_id'];?>" class="btn btn-xs btn-info">
                                  Change Writer Image
                                </a>
                                <?php } ?>
                                <hr>
                                <a href="editNewsImagesEnglish.php?ref=<?php echo $news['news_id'];?>" class="btn btn-xs btn-info">
                                  Change News Images
                                </a>
                                <hr>
                                <a href="deleteNewsEnglish.php?ref=<?php echo $news['news_id'];?>" onclick="return confirm('Really Deleting that News??');" class="btn btn-xs btn-danger">
                                  Delete
                                </a></td> 
                            </tr>
                            <?php endforeach; ?>
