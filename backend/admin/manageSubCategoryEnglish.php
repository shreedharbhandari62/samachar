               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#">English Subcategory</a>
                           <span class="divider">/</span>
                       </li>
                       <li class="active">
                           Manage English Subcategory
                       </li>
            ...
            <div class="row-fluid">
                ...
                <?php if (isset($_SESSION['msg']))  echo $_SESSION['msg']; unset($_SESSION['msg']);?>
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Sub-Category Information</h4>
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody>
                            <?php $catagories=getSubCategoriesDetailsEnglish($conn);
                            foreach ($catagories as $key => $catagory):
                                $categoryname=selectCategoryNameByIDEnglish($conn,$catagory['category_id']);
                            ?>
                            <tr class="odd gradeX">
                                ...
                                <td class="center hidden-phone"><?php if($catagory['is_active']=='active'): ?>
															...
															<?php else: ?>
																<span class="label label-sm label-danger">
																	Inactive</span>
															<?php endif; ?></td>
                                <td class="hidden-phone"><a href="editSubCategoryEnglish.php?ref=<?php echo $catagory['subcategory_id'];?>" class="btn btn-xs btn-info">
																	Edit
																</a>
																<a href="deleteSubCategoryEnglish.php?ref=<?php echo $catagory['subcategory_id'];?>" onclick="return confirm('Really Deleting that user??');" class="btn btn-xs btn-danger">
																	Delete
																</a></td>
                            </tr>
                            <?php endforeach; ?>
