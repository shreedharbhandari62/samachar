 <?php
  ...
  $category=getCategoryByIdEnglish($conn, $category_id);
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>English Category Information </h4>
                            <span class="tools">
...
<?php 
 if (isset($_POST['savebtn'])) {
    if(updateCategoryEnglish($conn, $_POST)){
