                ...
                <div class="span12">
                    ...
                    <div class="widget yellow">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Add Trending Topics</h4>
                        <span class="tools">
                           ...
                           <div class="control-group">
                            ...
                            <div class="control-group">
                             ...
                             <div class="form-actions">
                                ...
                                <a href="manageTrendingEnglish.php" class="btn btn-xs btn-danger"> Cancel </a>
                            </div>   
                            </form>
                            <!-- END FORM-->
                        </div>
...
<?php
if(isset($_POST['addTrending'])){

if(insertTrendingEnglish($conn, $_POST)){
    echo '<script language="javascript">';
    echo '</script>';
    showMsg('Trending Topic Added Successfully');
