                    ...
                    <div class="widget yellow">
                        ...
                        <div class="widget-body form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " required name="news_title" value="<?php echo $result['news_title'];?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6" readonly value ="Other"  name="category_name" />
                                    <!-- <span class="help-inline">Some hint here</span> -->
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6" readonly value ="Photo - Video" name="subcategory_name" />
                                    <!-- <span class="help-inline">Some hint here</span> -->
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " required  name="news_writtenby" value="<?php echo $result['news_writtenby'];?>"/>
                                    <!-- <span class="help-inline">Some hint here</span> -->
                                </div>
                            </div> 
                            <div class="control-group">
...
if(updateVideoNewsEnglish($conn, $_POST,$ref)){
