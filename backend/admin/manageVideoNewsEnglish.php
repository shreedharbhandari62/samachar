                ...
                <?php if (isset($_SESSION['msg']))  echo $_SESSION['msg']; unset($_SESSION['msg']);?>
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody>
                            <?php $newsVideos=getAllVideoNewsDetailsEnglish($conn);
                            ...
                            <tr class="odd gradeX">
                              ...
                              <td class="hidden-phone"><?php
                                ...
                                <td class="hidden-phone"><a href="editVideoNewsInfoEnglish.php?ref=<?php echo $video['news_id'];?>" class="btn btn-xs btn-info">
                                  Edit
                                </a>
                                <hr>
                                <a href="editVideoThumbnailEnglish.php?ref=<?php echo $video['news_id'];?>" class="btn btn-xs btn-info">
                                  Change Thumbnail
                                </a>
                                <a href="editVideoEnglish.php?ref=<?php echo $video['news_id'];?>" class="btn btn-xs btn-info">
                                  Change Video
                                </a>
                                <hr>
                                <a href="deleteVideoNewsEnglish.php?ref=<?php echo $video['news_id'];?>" onclick="return confirm('Really Deleting that News??');" class="btn btn-xs btn-danger">
                                  Delete
                                </a></td> 
                            </tr>
                            <?php endforeach; ?>
